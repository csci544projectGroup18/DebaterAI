...
class SampleDataset(Dataset):
    ...
    def __getitem__(self, index):
        return {
            "parent_comment": self.data[index][0],
            "child_comment": self.data[index][1],
            "context": self.data[index][2],
...
if __name__ == '__main__':
    ...
    raw_train = get_sample(20)
    raw_eval = get_sample(8)
    train_dataset = SampleDataset(raw_train)
    eval_dataset = SampleDataset(raw_eval)
